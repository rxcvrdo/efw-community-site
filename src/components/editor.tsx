          ...
          disabled && "opacity-50"
            ...
            <div className="flex px-2 pb-2 z-[5]">
                ...
                <EmojiPopover onEmojiSelect={onEmojiSelect}>
                    ...
                    {variant === "create" && (
                <Hint label="Attatch images and other files">
                <Button disabled={disabled}
                size="iconSm"
                variant="ghost"
                ...
                {variant === "update" && (
                  <div className="ml-auto flex items-center gap-x-2">
                    ...
                    size="sm"
                    className="bg-[#080808] hover:bg-[#080808]/80 text-white">
                      Save 
                    </Button>
                  </div>
                )}
                ...
                onClick={() => {
                 ...
                 className={cn("ml-auto",
                  isEmpty
                  ?"bg-white hover:bg-[#080808]/80 text-muted-foreground "
                  :"bg-[#080808] hover:bg-[#080808]/80 text-white ")}>
